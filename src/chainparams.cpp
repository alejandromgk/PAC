...
// Copyright (c) 2018-2019 The $PAC Core developers
...
public:
    CMainParams() {
        ...
        vSporkAddresses = {"PJZ3SkvPtcEX4HUt6R2UqiP2QJRngV9EFU"};
        nMinSporkKeys = 1;
...
public:
    CTestNetParams() {
        ...
        // Testnet PAC addresses start with 'q'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,120);
        // Testnet PAC script addresses start with '6' or '7'
        ...
        vSporkAddresses = {"qWDfemL38E2D66WLrHYjxg7oTzuVZ5UAaR"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;
        ...
        chainTxData = ChainTxData{
            1517541975, // * UNIX timestamp of last known number of transactions
...
public:
    CRegTestParams() {
        ...
        // privKey: cTh45ztYxMS1EHCBv4mnFNryEgeGcoWKbKc3Rtpc9LgKWwoQjtJB
        vSporkAddresses = {"qQ5QYoNVsW9ujzeoNTYrDgD8izYRYvWFmM"};
        nMinSporkKeys = 1;
