...
QString BitcoinUnits::description(int unit)
{
    ...
    else
    {
        switch(unit)
        {
            case PAC: return QString("TestPACs");
            case mPAC: return QString("Milli-TestPAC (1 / 1" THIN_SP_UTF8 "000)");
            case uPAC: return QString("Micro-TestPAC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
