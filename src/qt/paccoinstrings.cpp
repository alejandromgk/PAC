...
QT_TRANSLATE_NOOP("paccoin-core", "PAC Core"),
QT_TRANSLATE_NOOP("paccoin-core", "The %s developers"),
...
QT_TRANSLATE_NOOP("paccoin-core", ""
"Disable all PAC specific functionality (Masternodes, PrivatePAC, "
...
"default: %u)"),
QT_TRANSLATE_NOOP("paccoin-core", ""
"Enable publish raw transactions of attempted InstantPAC double spend in "
"<address>"),
QT_TRANSLATE_NOOP("paccoin-core", ""
"Enable publish transaction hashes of attempted InstantPAC double spend in "
"<address>"),
QT_TRANSLATE_NOOP("paccoin-core", ""
...
QT_TRANSLATE_NOOP("paccoin-core", "Allow RFC1918 addresses to be relayed and connected to (default: %u)"),
QT_TRANSLATE_NOOP("paccoin-core", "Already have that input."),
QT_TRANSLATE_NOOP("paccoin-core", "Always query for peer addresses via DNS lookup (default: %u)"),
QT_TRANSLATE_NOOP("paccoin-core", "Append comment to the user agent string"),
QT_TRANSLATE_NOOP("paccoin-core", "Attempt to recover private keys from a corrupt wallet on startup"),
QT_TRANSLATE_NOOP("paccoin-core", "Automatic backups disabled"),
QT_TRANSLATE_NOOP("paccoin-core", "Automatically create Tor hidden service (default: %d)"),
QT_TRANSLATE_NOOP("paccoin-core", "Block creation options:"),
QT_TRANSLATE_NOOP("paccoin-core", "Can't find random Masternode."),
QT_TRANSLATE_NOOP("paccoin-core", "Can't mix while sync in progress."),
QT_TRANSLATE_NOOP("paccoin-core", "Can't mix: no compatible inputs found!"),
QT_TRANSLATE_NOOP("paccoin-core", "Cannot downgrade wallet"),
QT_TRANSLATE_NOOP("paccoin-core", "Cannot resolve -%s address: '%s'"),
QT_TRANSLATE_NOOP("paccoin-core", "Cannot write default address"),
QT_TRANSLATE_NOOP("paccoin-core", "Chain selection options:"),
QT_TRANSLATE_NOOP("paccoin-core", "Change index out of range"),
QT_TRANSLATE_NOOP("paccoin-core", "Collateral not valid."),
QT_TRANSLATE_NOOP("paccoin-core", "Connect through SOCKS5 proxy"),
QT_TRANSLATE_NOOP("paccoin-core", "Connect to KeePassHttp on port <port> (default: %u)"),
...
QT_TRANSLATE_NOOP("paccoin-core", "Enable publish hash of governance objects (like proposals) in <address>"),
QT_TRANSLATE_NOOP("paccoin-core", "Enable publish hash of governance votes in <address>"),
...
QT_TRANSLATE_NOOP("paccoin-core", "Entries are full."),
QT_TRANSLATE_NOOP("paccoin-core", "Entry exceeds maximum size."),
QT_TRANSLATE_NOOP("paccoin-core", "Error initializing block database"),
QT_TRANSLATE_NOOP("paccoin-core", "Error initializing wallet database environment %s!"),
QT_TRANSLATE_NOOP("paccoin-core", "Error loading %s"),
QT_TRANSLATE_NOOP("paccoin-core", "Error loading %s: Wallet corrupted"),
QT_TRANSLATE_NOOP("paccoin-core", "Error loading %s: Wallet requires newer version of %s"),
QT_TRANSLATE_NOOP("paccoin-core", "Error loading %s: You can't disable HD on a already existing HD wallet"),
QT_TRANSLATE_NOOP("paccoin-core", "Error loading block database"),
QT_TRANSLATE_NOOP("paccoin-core", "Error opening block database"),
QT_TRANSLATE_NOOP("paccoin-core", "Error reading from database, shutting down."),
QT_TRANSLATE_NOOP("paccoin-core", "Error upgrading chainstate database"),
QT_TRANSLATE_NOOP("paccoin-core", "Error"),
QT_TRANSLATE_NOOP("paccoin-core", "Error: A fatal internal error occurred, see debug.log for details"),
QT_TRANSLATE_NOOP("paccoin-core", "Error: Disk space is low!"),
QT_TRANSLATE_NOOP("paccoin-core", "Failed to create backup %s!"),
QT_TRANSLATE_NOOP("paccoin-core", "Failed to create backup, error: %s"),
QT_TRANSLATE_NOOP("paccoin-core", "Failed to delete backup, error: %s"),
QT_TRANSLATE_NOOP("paccoin-core", "Failed to find mixing queue to join"),
QT_TRANSLATE_NOOP("paccoin-core", "Failed to listen on any port. Use -listen=0 if you want this."),
QT_TRANSLATE_NOOP("paccoin-core", "Failed to load InstantPAC data cache from"),
...
QT_TRANSLATE_NOOP("paccoin-core", "Found enough users, signing ..."),
QT_TRANSLATE_NOOP("paccoin-core", "How many blocks to check at startup (default: %u, 0 = all)"),
QT_TRANSLATE_NOOP("paccoin-core", "Importing..."),
QT_TRANSLATE_NOOP("paccoin-core", "Imports blocks from external blk000??.dat file on startup"),
QT_TRANSLATE_NOOP("paccoin-core", "Include IP addresses in debug output (default: %u)"),
QT_TRANSLATE_NOOP("paccoin-core", "Incompatible mode."),
QT_TRANSLATE_NOOP("paccoin-core", "Incompatible version."),
QT_TRANSLATE_NOOP("paccoin-core", "Incorrect or no genesis block found. Wrong datadir for network?"),
QT_TRANSLATE_NOOP("paccoin-core", "Information"),
QT_TRANSLATE_NOOP("paccoin-core", "Initialization sanity check failed. %s is shutting down."),
...
QT_TRANSLATE_NOOP("paccoin-core", "KeePassHttp key for AES encrypted communication with KeePass"),
QT_TRANSLATE_NOOP("paccoin-core", "Keep N PAC anonymized (%u-%u, default: %u)"),
...
QT_TRANSLATE_NOOP("paccoin-core", "Maximum per-connection receive buffer, <n>*1000 bytes (default: %u)"),
QT_TRANSLATE_NOOP("paccoin-core", "Maximum per-connection send buffer, <n>*1000 bytes (default: %u)"),
QT_TRANSLATE_NOOP("paccoin-core", "Minimum bytes per sigop in transactions we relay and mine (default: %u)"),
QT_TRANSLATE_NOOP("paccoin-core", "Missing input transaction information."),
QT_TRANSLATE_NOOP("paccoin-core", "Mixing in progress..."),
QT_TRANSLATE_NOOP("paccoin-core", "Mnemonic passphrase is too long, must be at most 256 characters"),
QT_TRANSLATE_NOOP("paccoin-core", "Need to specify a port with -whitebind: '%s'"),
QT_TRANSLATE_NOOP("paccoin-core", "No Masternodes detected."),
QT_TRANSLATE_NOOP("paccoin-core", "No compatible Masternode found."),
QT_TRANSLATE_NOOP("paccoin-core", "No errors detected."),
QT_TRANSLATE_NOOP("paccoin-core", "No matching denominations found for mixing."),
QT_TRANSLATE_NOOP("paccoin-core", "Node relay options:"),
QT_TRANSLATE_NOOP("paccoin-core", "Non-standard public key detected."),
QT_TRANSLATE_NOOP("paccoin-core", "Not compatible with existing transactions."),
QT_TRANSLATE_NOOP("paccoin-core", "Not enough file descriptors available."),
QT_TRANSLATE_NOOP("paccoin-core", "Not enough funds to anonymize."),
QT_TRANSLATE_NOOP("paccoin-core", "Not in the Masternode list."),
QT_TRANSLATE_NOOP("paccoin-core", "Number of automatic wallet backups (default: %u)"),
...
QT_TRANSLATE_NOOP("paccoin-core", "RPC server options:"),
QT_TRANSLATE_NOOP("paccoin-core", "Rebuild chain state and block index from the blk*.dat files on disk"),
QT_TRANSLATE_NOOP("paccoin-core", "Rebuild chain state from the currently indexed blocks"),
QT_TRANSLATE_NOOP("paccoin-core", "Receive and display P2P network alerts (default: %u)"),
QT_TRANSLATE_NOOP("paccoin-core", "Reducing -maxconnections from %d to %d, because of system limitations."),
QT_TRANSLATE_NOOP("paccoin-core", "Relay and mine data carrier transactions (default: %u)"),
QT_TRANSLATE_NOOP("paccoin-core", "Relay non-P2SH multisig (default: %u)"),
QT_TRANSLATE_NOOP("paccoin-core", "Rescan the block chain for missing wallet transactions on startup"),
...
QT_TRANSLATE_NOOP("paccoin-core", "Send trace/debug info to debug.log file (default: %u)"),
QT_TRANSLATE_NOOP("paccoin-core", "Send transactions as zero-fee transactions if possible (default: %u)"),
QT_TRANSLATE_NOOP("paccoin-core", "Session not complete!"),
QT_TRANSLATE_NOOP("paccoin-core", "Session timed out."),
QT_TRANSLATE_NOOP("paccoin-core", "Set database cache size in megabytes (%d to %d, default: %d)"),
...
QT_TRANSLATE_NOOP("paccoin-core", "Signing transaction failed"),
...
QT_TRANSLATE_NOOP("paccoin-core", "This is experimental software."),
QT_TRANSLATE_NOOP("paccoin-core", "This is not a Masternode."),
QT_TRANSLATE_NOOP("paccoin-core", "This is the minimum transaction fee you pay on every transaction."),
QT_TRANSLATE_NOOP("paccoin-core", "This is the transaction fee you will pay if you send a transaction."),
QT_TRANSLATE_NOOP("paccoin-core", "Threshold for disconnecting misbehaving peers (default: %u)"),
QT_TRANSLATE_NOOP("paccoin-core", "Too many %f denominations, removing."),
QT_TRANSLATE_NOOP("paccoin-core", "Too many %f denominations, skipping."),
QT_TRANSLATE_NOOP("paccoin-core", "Tor control port password (default: empty)"),
QT_TRANSLATE_NOOP("paccoin-core", "Tor control port to use if onion listening enabled (default: %s)"),
QT_TRANSLATE_NOOP("paccoin-core", "Transaction amount too small"),
QT_TRANSLATE_NOOP("paccoin-core", "Transaction amounts must not be negative"),
QT_TRANSLATE_NOOP("paccoin-core", "Transaction created successfully."),
QT_TRANSLATE_NOOP("paccoin-core", "Transaction fees are too high."),
QT_TRANSLATE_NOOP("paccoin-core", "Transaction has too long of a mempool chain"),
QT_TRANSLATE_NOOP("paccoin-core", "Transaction must have at least one recipient"),
QT_TRANSLATE_NOOP("paccoin-core", "Transaction not valid."),
QT_TRANSLATE_NOOP("paccoin-core", "Transaction too large for fee policy"),
QT_TRANSLATE_NOOP("paccoin-core", "Transaction too large"),
QT_TRANSLATE_NOOP("paccoin-core", "Trying to connect..."),
QT_TRANSLATE_NOOP("paccoin-core", "Unable to bind to %s on this computer (bind returned error %s)"),
QT_TRANSLATE_NOOP("paccoin-core", "Unable to bind to %s on this computer. %s is probably already running."),
QT_TRANSLATE_NOOP("paccoin-core", "Unable to sign spork message, wrong key?"),
QT_TRANSLATE_NOOP("paccoin-core", "Unable to start HTTP server. See debug log for details."),
QT_TRANSLATE_NOOP("paccoin-core", "Unknown network specified in -onlynet: '%s'"),
QT_TRANSLATE_NOOP("paccoin-core", "Unknown response."),
QT_TRANSLATE_NOOP("paccoin-core", "Unknown state: id = %u"),
QT_TRANSLATE_NOOP("paccoin-core", "Unsupported argument -benchmark ignored, use -debug=bench."),
QT_TRANSLATE_NOOP("paccoin-core", "Unsupported argument -debugnet ignored, use -debug=net."),
QT_TRANSLATE_NOOP("paccoin-core", "Unsupported argument -tor found, use -onion."),
QT_TRANSLATE_NOOP("paccoin-core", "Upgrade wallet to latest format on startup"),
QT_TRANSLATE_NOOP("paccoin-core", "Upgrading UTXO database"),
QT_TRANSLATE_NOOP("paccoin-core", "Use KeePass 2 integration using KeePassHttp plugin (default: %u)"),
QT_TRANSLATE_NOOP("paccoin-core", "Use UPnP to map the listening port (default: %u)"),
QT_TRANSLATE_NOOP("paccoin-core", "Use devnet chain with provided name"),
QT_TRANSLATE_NOOP("paccoin-core", "Use the test chain"),
QT_TRANSLATE_NOOP("paccoin-core", "User Agent comment (%s) contains unsafe characters."),
QT_TRANSLATE_NOOP("paccoin-core", "Username for JSON-RPC connections"),
QT_TRANSLATE_NOOP("paccoin-core", "Verifying blocks..."),
QT_TRANSLATE_NOOP("paccoin-core", "Verifying wallet..."),
QT_TRANSLATE_NOOP("paccoin-core", "Very low number of keys left: %d"),
QT_TRANSLATE_NOOP("paccoin-core", "Wallet %s resides outside data directory %s"),
QT_TRANSLATE_NOOP("paccoin-core", "Wallet debugging/testing options:"),
QT_TRANSLATE_NOOP("paccoin-core", "Wallet is locked."),
QT_TRANSLATE_NOOP("paccoin-core", "Wallet is not initialized"),
QT_TRANSLATE_NOOP("paccoin-core", "Wallet needed to be rewritten: restart %s to complete"),
QT_TRANSLATE_NOOP("paccoin-core", "Wallet options:"),
QT_TRANSLATE_NOOP("paccoin-core", "Wallet window title"),
QT_TRANSLATE_NOOP("paccoin-core", "Warning"),
QT_TRANSLATE_NOOP("paccoin-core", "Warning: unknown new rules activated (versionbit %i)"),
QT_TRANSLATE_NOOP("paccoin-core", "Wasn't able to create wallet backup folder %s!"),
QT_TRANSLATE_NOOP("paccoin-core", "Whether to operate in a blocks only mode (default: %u)"),
QT_TRANSLATE_NOOP("paccoin-core", "Will retry..."),
QT_TRANSLATE_NOOP("paccoin-core", "You can not start a masternode in lite mode."),
QT_TRANSLATE_NOOP("paccoin-core", "Your entries added successfully."),
QT_TRANSLATE_NOOP("paccoin-core", "Your transaction was accepted into the pool!"),
QT_TRANSLATE_NOOP("paccoin-core", "Zapping all transactions from wallet..."),
QT_TRANSLATE_NOOP("paccoin-core", "ZeroMQ notification options:"),
QT_TRANSLATE_NOOP("paccoin-core", "no mixing available."),
QT_TRANSLATE_NOOP("paccoin-core", "see debug.log for details."),
};
