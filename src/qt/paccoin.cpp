...
{
    return QCoreApplication::translate("paccoin-core", psz).toStdString();
}
...
static void initTranslations(QTranslator &qtTranslatorBase, QTranslator &qtTranslator, QTranslator &translatorBase, QTranslator &translator)
{
    ...
    // Load e.g. bitcoin_de.qm (shortcut "de" needs to be defined in paccoin.qrc)
    if (translatorBase.load(lang, ":/translations/"))
        QApplication::installTranslator(&translatorBase);

    // Load e.g. bitcoin_de_DE.qm (shortcut "de_DE" needs to be defined in paccoin.qrc)
...
/** Class encapsulating PAC Core startup and shutdown.
...
void BitcoinApplication::initializeResult(bool success)
{
    ...
    if(success)
    {
        ...
        // paccoin: URIs or payment requests:
...
int main(int argc, char *argv[])
{
    ...
    Q_INIT_RESOURCE(paccoin);
    Q_INIT_RESOURCE(paccoin_locale);
    ...
    /// 6. Determine availability of data directory and parse paccoin.conf
    ...
    // paccoin: links repeatedly have their payment requests routed to this process:
