...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210 PAC from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 PAC in block rewards plus fees, but
        ...
        # Send 100 PAC with subtract fee from amount
        ...
        # Sendmany 100 PAC with subtract fee from amount
